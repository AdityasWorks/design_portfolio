    ...
    <div className="relative overflow-hidden pt-2">
      ...
      <div className=" pb-12 px-6">
        ...
        <VantaBackground>
          ...
          >
            <h2 className="text-2xl md:text-xl font-medium mb-3 text-white font">Good design can make even a bad product sell.</h2>
          </motion.div>
        </VantaBackground>
        <div className="pt-13 max-w-7xl mx-auto">
          ...
          <div className="text-center ">
            ...
            >
              I craft beautiful digital experiences with code, motion graphics, and user-centered design thinking.
            </motion.p>
